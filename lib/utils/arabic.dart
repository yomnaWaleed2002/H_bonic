const Map<String, String> ur_PK = {
  ...
  'setting': 'الاعدادات',
  'chat': 'المحادثه',
  'Connect to a H-bionc': 'الاتصال بالطرف',
  'Connected to H-bionic': 'تم الاتصال بالطرف',
  'Received data': 'بيانات المستخدم',
  'Heart’s bpm': 'ضربات القلب',
  'heart rate': 'معدل ضربات القلب',
  'oxygen rate': 'نسبه الاكسجين في الدم',
